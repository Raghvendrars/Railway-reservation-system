...
<div id="wrap">
   ...
   <form class="form-horizontal login_validator" id="tryitForm" action="trainregistration.php" method="POST" enctype="multipart/form-data">
                                <div class="row">
                                    <div class="col-12">
...
<!--                                   <div class="form-group row">
                                            <div class="col-lg-3 text-lg-right">
                                                <label for="email" class="col-form-label">id
                                                    *</label>
                                            </div>
                                ...
                                <div class="form-group row m-t-25">
                                <div class="col-lg-3 text-lg-right">
                                <label for="u-name" class="col-form-label">Train Number *</label>
                                </div>
                                <div class="col-xl-6 col-lg-8">
                                <div class="input-group">
                                ...
                                <input type="text" name="txtnum" id="u-name" class="form-control" >
                                </div>
                                </div>
                                 </div>
                                 ...
                                 <div class="form-group row">
                                            <div class="col-lg-3 text-lg-right">
                                                <label for="phone" class="col-form-label">Train Name
                                                    *</label>
                                            </div>
                                            <div class="col-xl-6 col-lg-8">
                                                <div class="input-group">
                                                    <span class="input-group-addon"><i class="fa fa-phone text-primary"></i></span>
                                                    <input type="text" placeholder=" " id="phone" name="txtname"
                                                           class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            <div class="col-lg-3 text-lg-right">
                                                <label for="email" class="col-form-label">Source
                                                    *</label>
                                            </div>
                                            <div class="col-xl-6 col-lg-8">
                                                <div class="input-group">
                                                    <span class="input-group-addon"><i class="fa fa-envelope text-primary"></i></span>
                                                    <input type="text" placeholder=" " id="email" name="txtsrc"
                                                           class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            <div class="col-lg-3 text-lg-right">
                                                <label for="email" class="col-form-label">Destination
                                                    *</label>
                                            </div>
                                            <div class="col-xl-6 col-lg-8">
                                                <div class="input-group">
                                                    <span class="input-group-addon"><i class="fa fa-envelope text-primary"></i></span>
                                                    <input type="text" placeholder=" " id="email" name="txtdest"
                                                           class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="form-group row">
                                 <div class="col-lg-3 text-lg-right">
                                 <label for="pwd" class="col-form-label">Date *</label>
                                 </div>
                                <div class="col-xl-6 col-lg-8">
                                <div class="input-group">
                                <span class="input-group-addon">
                                <i class="fa fa-lock text-primary"></i></span>
                                <input type="text" name="dt[]" id="pwd" class="form-control">
                                </div>
                                </div>
                                </div>
                                ...
                                <div class="form-group row">
                                <div class="col-lg-3 text-lg-right">
                                <label for="cpwd" class="col-form-label">Class *</label>
                                </div>
                                <div class="col-xl-6 col-lg-8">
                                <div class="input-group">
