			...
			<div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
				<form class="login100-form validate-form" action="registration.php" method="POST">
					...
					<div class="wrap-input100 validate-input m-b-23" data-validate = "Username is reauired">
					  ...
					  <input class="input100" type="text" name="txtuname" placeholder="Type your username">
						<span class="focus-input100" data-symbol="&#xf206;"></span>
					</div>
					<div class="wrap-input100 validate-input m-b-23" data-validate = "Phone is reauired">
						<span class="label-input100">Phone</span>
					  <input class="input100" type="text" name="txtph" placeholder="Type your phone">
						<span class="focus-input100" data-symbol="&#xf206;"></span>
					</div>
					...
					<div class="container-login100-form-btn">
					  ...
					  <button class="login100-form-btn" type="submit" name="btnInsert">Signup</button>
