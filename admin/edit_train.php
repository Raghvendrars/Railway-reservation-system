...
z-index: 999999">
                    ...
                    <div class="media user-media">
                        ...
                        <div class="user-wrapper">
                            <a class="user-link" href="#">
                                ...
                                <p class="text-white user-info">Welcome Raghvendra</p>
                            </a>
    ...
    <form class="form-horizontal login_validator" id="tryitForm" action="updatetrain.php?getid=<?php echo $id ?>" method="POST">
     ...
     <input type="hidden" name="editID" value="<?php echo $id; ?>"><br>
                            ...
                            <div class="form-group row m-t-25">
                                ...
                                <input type="text" name="txtnum" id="u-name" class="form-control" value="<?php echo $data['train_num'];?>">
                                </div>
                                </div>
                                 </div>
                                 ...
                                 <div class="col-lg-3 text-lg-right">
                                 <label for="phone" class="col-form-label">Train Name *</label>
                                 </div>
                                 <div class="col-xl-6 col-lg-8">
                                 <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-phone text-primary"></i></span>
                        <input type="text" placeholder=" " id="phone" name="txtname" value="<?php echo $data['train_name'];?>" class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <input type="text" placeholder=" " id="email" name="txtsrc" value="<?php echo $data['source'];?>" class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                <div class="form-group row">
                                 <div class="col-lg-3 text-lg-right">
                                 <label for="pwd" class="col-form-label">Destination *</label>
                                 </div>
                                <div class="col-xl-6 col-lg-8">
                                <div class="input-group">
                                <span class="input-group-addon">
                                <i class="fa fa-lock text-primary"></i></span>
                                <input type="text" name="txtdest" id="pwd" class="form-control" value="<?php echo $data['destination'];?>">
                                </div>
                                </div>
                                </div>
